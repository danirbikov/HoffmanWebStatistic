                ...
                (function() {
                    ...
                    function d(t, e, s) {
                        ...
                        case s._const.modifyTextElement:
                            ...
                            i.parentNode instanceof HTMLTextAreaElement && (i.parentNode.value = e[s._const.newValue]);
                            break;
                        ...
                        case s._const.addTextElement:
                            ...
                            if (n = s.document.createTextNode(e[s._const.value]),
                            !(i = l(t, f)).childNodes)
                                return !1;
                            i.insertBefore(n, i.childNodes[u] || null),
                            i.parentNode instanceof HTMLTextAreaElement && (i.parentNode.value = e[s._const.value]);
                            break;
                        default:
                      ...
                      , v = function(t, e, s, i, n) {
                        ...
                        if (t.attributes && e.attributes) {
                            ...
                            if (t.attributes.class && t.attributes.class === e.attributes.class)
                                if ("".concat(t.nodeName, ".").concat(t.attributes.class.replace(/ /g, "."))in s)
                                    return !0
                        }
                        if (i)
                            return !0;
                            ...
                            var t = function(t, e, s, i) {
                                ...
                                for (var h = 0; h < o; h++)
                                    for (var p = t[h], m = 0; m < r; m++) {
                                        var g = e[m];
                                        s[h] || i[m] || !v(p, g, d, c) ? l[h + 1][m + 1] = 0 : (l[h + 1][m + 1] = l[h][m] ? l[h][m] + 1 : 1,
                                        l[h + 1][m + 1] >= n && (n = l[h + 1][m + 1],
                                        a = [h + 1, m + 1]))
                                    }
                                return 0 !== n && {
                                    oldValue: a[0] - n,
                        ...
                        return e.forEach((function(e) {
                            !function(t, e, s) {
                                ...
                                case s._const.modifyTextElement:
                                    ...
                                    "TEXTAREA" === a.nodeName && (a.value = e[s._const.newValue]);
                                    break;
                                case s._const.modifyValue:
                    ...
                    function M(t, e) {
                        ...
                        if (t instanceof Text || t instanceof Comment)
                            ...
                            e.valueDiffing && (t instanceof HTMLTextAreaElement && (s.value = t.value),
                            t instanceof HTMLInputElement && ["radio", "checkbox"].includes(t.type.toLowerCase()) && void 0 !== t.checked ? s.checked = t.checked : (t instanceof HTMLButtonElement || t instanceof HTMLDataElement || t instanceof HTMLInputElement || t instanceof HTMLLIElement || t instanceof HTMLMeterElement || t instanceof HTMLOptionElement || t instanceof HTMLProgressElement || t instanceof HTMLParamElement) && (s.value = t.value),
                    ...
                    var $ = {
                        ...
                        return t.replace(O, (function(o, r) {
                            ...
                            if (d) {
                                ...
                                if (n < 0)
                                    ...
                                    "";
                                var p = a[n];
                                return p && u.nodeName && (p.node.childNodes || (p.node.childNodes = []),
                            ...
                            if ((!l || s.voidElement) && (n > -1 && (s.voidElement || s.node.nodeName.toUpperCase() === o.slice(2, -1).toUpperCase()) && --n > -1 && (s = a[n]),
                            "<" !== h && h)) {
                      ...
                      , T = function() {
                        function t(t, e, s) {
                            ...
                            this.diffcount = 0,
                            this.foundAll = !1,
                            this.debug && (this.t1Orig = "undefined" != typeof Element && t instanceof Element ? M(t, this.options) : "string" == typeof t ? C(t, this.options) : JSON.parse(JSON.stringify(t)),
                        ...
                        t.prototype.findDiffs = function(t, e) {
                            ...
                            do {
                                ...
                                0 === (s = this.findNextDiff(t, e, [])).length && (b(t, e) || (this.foundAll ? console.error("Could not find remaining diffs!") : (this.foundAll = !0,
                                m(t),
                        ...
                        t.prototype.findOuterDiff = function(t, e, s) {
                            ...
                            if (Object.prototype.hasOwnProperty.call(t, "data") && t.data !== e.data)
                                return "#text" === t.nodeName ? [(new x).setValue(this.options._const.action, this.options._const.modifyTextElement).setValue(this.options._const.route, s).setValue(this.options._const.oldValue, t.data).setValue(this.options._const.newValue, e.data)] : [(new x).setValue(this.options._const.action, this.options._const.modifyComment).setValue(this.options._const.route, s).setValue(this.options._const.oldValue, t.data).setValue(this.options._const.newValue, e.data)];
                            for (n = t.attributes ? Object.keys(t.attributes).sort() : [],
                            a = e.attributes ? Object.keys(e.attributes).sort() : [],
                            o = n.length,
                            l = 0; l < o; l++)
                                i = n[l],
                                -1 === (r = a.indexOf(i)) ? d.push((new x).setValue(this.options._const.action, this.options._const.removeAttribute).setValue(this.options._const.route, s).setValue(this.options._const.name, i).setValue(this.options._const.value, t.attributes[i])) : (a.splice(r, 1),
                                t.attributes[i] !== e.attributes[i] && d.push((new x).setValue(this.options._const.action, this.options._const.modifyAttribute).setValue(this.options._const.route, s).setValue(this.options._const.name, i).setValue(this.options._const.oldValue, t.attributes[i]).setValue(this.options._const.newValue, e.attributes[i])));
                            for (o = a.length,
                            l = 0; l < o; l++)
                                i = a[l],
                                d.push((new x).setValue(this.options._const.action, this.options._const.addAttribute).setValue(this.options._const.route, s).setValue(this.options._const.name, i).setValue(this.options._const.value, e.attributes[i]));
                            return d
                        }
                        ,
                                ...
                                u && p)
                                    if (!this.options.maxChildCount || a < this.options.maxChildCount)
                                        ...
                                        if (i.length > n.length)
                                            ...
                                            r = r.concat([(new x).setValue(this.options._const.action, this.options._const.replaceElement).setValue(this.options._const.oldValue, g(u)).setValue(this.options._const.newValue, g(p)).setValue(this.options._const.route, s.concat(l))]);
                                l += 1
                            }
                        ...
                        t.prototype.attemptGroupRelocation = function(t, e, s, i, n) {
                            ...
                            }(t, e, s), u = h.gaps1, p = h.gaps2, f = Math.min(u.length, p.length), m = [], b = 0, _ = 0; b < f; _ += 1,
                            b += 1)
                                if (!n || !0 !== u[b] && !0 !== p[b]) {
                                    if (!0 === u[b])
                                            ...
                                            if ("#text" === e.childNodes[b].nodeName) {
                                                if (l.data !== e.childNodes[b].data) {
                                                    for (c = _; t.childNodes.length > c + 1 && "#text" === t.childNodes[c + 1].nodeName; )
                                                        if (c += 1,
                                                        e.childNodes[b].data === t.childNodes[c].data) {
                                                            d = !0;
                                                            break
                                                        }
                                                    if (!d)
                                                        return m.push((new x).setValue(this.options._const.action, this.options._const.modifyTextElement).setValue(this.options._const.route, i.concat(b)).setValue(this.options._const.oldValue, l.data).setValue(this.options._const.newValue, e.childNodes[b].data)),
                                                        m
                                                }
                                            } else
                                        ...
                                        "#text" === (l = e.childNodes[b]).nodeName ? (m.push((new x).setValue(this.options._const.action, this.options._const.addTextElement).setValue(this.options._const.route, i.concat(b)).setValue(this.options._const.value, l.data)),
                                        u.splice(b, 0, !0),
                                        f = Math.min(u.length, p.length),
                                        _ -= 1) : (m.push((new x).setValue(this.options._const.action, this.options._const.addElement).setValue(this.options._const.route, i.concat(b)).setValue(this.options._const.element, g(l))),
                                        u.splice(b, 0, !0),
                                        f = Math.min(u.length, p.length),
                                        _ -= 1);
                                    else if (u[b] !== p[b]) {
                                        ...
                                        (o = Math.min(r.newValue, t.childNodes.length - r.length)) !== r.oldValue) {
                                            ...
                                            for (var y = 0; y < r.length; y += 1)
                                                v(t.childNodes[o + y], t.childNodes[r.oldValue + y], {}, !1, !0) || (a = !0);
                                            if (a)
                                                return [(new x).setValue(this.options._const.action, this.options._const.relocateGroup).setValue(this.options._const.groupLength, r.length).setValue(this.options._const.from, r.oldValue).setValue(this.options._const.to, o).setValue(this.options._const.route, i)]
                                        }
                                    }
                                } else
                                    ;
                        ...
                        t.prototype.findValueDiff = function(t, e, s) {
                            var i = [];
                            return t.selected !== e.selected && i.push((new x).setValue(this.options._const.action, this.options._const.modifySelected).setValue(this.options._const.oldValue, t.selected).setValue(this.options._const.newValue, e.selected).setValue(this.options._const.route, s)),
                            (t.value || e.value) && t.value !== e.value && "OPTION" !== t.nodeName && i.push((new x).setValue(this.options._const.action, this.options._const.modifyValue).setValue(this.options._const.oldValue, t.value || "").setValue(this.options._const.newValue, e.value || "").setValue(this.options._const.route, s)),
                            t.checked !== e.checked && i.push((new x).setValue(this.options._const.action, this.options._const.modifyChecked).setValue(this.options._const.oldValue, t.checked).setValue(this.options._const.newValue, e.checked).setValue(this.options._const.route, s)),
                            i
                        }
                        ,
                        t
                    ...
                    ({
                        ...
                        var M = function() {
                            ...
                            ,
                            b.$set = function(t, e) {
                                var s, l = D.p(t), c = "set" + (this.$u ? "UTC" : ""), p = (s = {},
                                s[r] = c + "Date",
                                s[u] = c + "Date",
                                s[d] = c + "Month",
                                s[h] = c + "FullYear",
                            ...
                            b.diff = function(i, u, p) {
                                var f, m = D.p(u), g = N(i), b = (g.utcOffset() - this.utcOffset()) * e, v = this - g, w = D.m(this, g);
                                return w = (f = {},
                                f[h] = w / 12,
                                f[d] = w,
                                f[c] = w / 3,
                        ...
                        [["$ms", i], ["$s", n], ["$m", a], ["$H", o], ["$W", r], ["$M", d], ["$y", h], ["$D", u]].forEach((function(t) {
                            O[t[1]] = function(e) {
                    ...
                    class U {
                        ...
                        add(t) {
                            ...
                            if (this.dt.data.headings = this.dt.data.headings.concat([B(t.heading)]),
                    ...
                    const J = {
                        ...
                        labels: {
                            ...
                            info: "Показан от {start} до {end} из {rows} элементов"
                        },
                      ...
                      , Q = (t,e,s,i,n)=>{
                        let a = [];
                        if (n.firstLast && a.push(W(1, n.firstText, n)),
                        n.nextPrev) {
                            const e = t ? 1 : s - 1;
                            a.push(W(e, n.prevText, n, {
                                hidden: t
                            }))
                        }
                        let o = [...Array(i).keys()].map((t=>W(t + 1, String(t + 1), n, {
                            active: t === s - 1
                        })));
                    ...
                    class Z {
                        ...
                        init() {
                            ...
                            this.options.menuItems && this.options.menuItems.length && this.options.menuItems.forEach((t=>{
                                ...
                                if (!t.separator) {
                                    ...
                                    e.appendChild(i),
                                    t.action && "function" == typeof t.action && i.addEventListener("click", (e=>{
                                        e.preventDefault(),
                                        t.action(this, e)
                                    }
                                    ))
                        ...
                        bindEvents() {
                            ...
                            this.options.contextMenu && (this.events.context = this.context.bind(this),
                        ...
                        keydown(t) {
                            if (this.modalDOM) {
                                ...
                                if ("Enter" === t.key) {
                                    ...
                                    "Escape" === t.key && (this.editingCell ? this.saveCell(this.data.content) : this.editingRow && this.saveRow(null, this.data.row))
                        }
                        editCell(t) {
                        ...
                        editCellModal() {
                            ...
                            o.addEventListener("click", (t=>{
                                const e = t.target;
                                e instanceof Element && (e.hasAttribute("data-editor-cancel") ? (t.preventDefault(),
                                this.options.cancelModal(this) && this.closeModal()) : e.hasAttribute("data-editor-save") && (t.preventDefault(),
                        ...
                        dismissMenu(t) {
                            ...
                            if (!(e instanceof Element) || this.wrapperDOM.contains(e))
                                return;
                            let s = !0;
                            this.editing && (s = !e.matches(`input.${this.options.classes.input}[type=text]`)),
                            s && this.closeMenu()
                        }
                        openMenu() {
                            if (this.editing && this.data && this.editingCell) {
                    ...
                    class K {
                        ...
                        dismiss() {
                            this.addedButtonDOM && this.buttonDOM.parentElement && this.buttonDOM.parentElement.removeChild(this.buttonDOM),
                    ...
                    exports.DataTable = class {
                        ...
                        _renderSeparateHeader() {
                            ...
                            if (e.attributes.class = e.attributes.class ? `${e.attributes.class} ${this.options.classes.table}` : this.options.classes.table,
                        ...
                        multiSearch(t) {
                            ...
                            const s = e.map((t=>this.columns.settings.map(((e,s)=>{
                                ...
                                ["base", "accent"].includes(n) && (i = i.map((t=>t.toLowerCase()))),
                                ["base", "case"].includes(n) && (i = i.map((t=>t.normalize("NFD").replace(/\p{Diacritic}/gu, ""))));
                                return (e.ignorePunctuation ?? this.options.ignorePunctuation) && (i = i.map((t=>t.replace(/[.,/#!$%^&*;:{}=-_`~()]/g, "")))),
                                i
                            }
                            ))));
                            ...
                            if (Array.isArray(e)) {
                                ...
                                e.forEach(((e,i)=>{
                                    ...
                                    Object.entries(e).forEach((([e,s])=>{
                                        const a = t.indexOf(e);
                                        a > -1 ? n[a] = q(s, this.columns.settings[a]) : this.hasHeadings || this.hasRows || 0 !== i || (n[t.length] = q(s, this.columns.settings[t.length]),
                                        t.push(e),
                                ...
                                t(e) && (!e.headings || this.hasHeadings || this.hasRows ? e.data && Array.isArray(e.data) && (s = e.data.map((t=>t.map(((t,e)=>q(t, this.columns.settings[e])))))) : this.data = F(e, void 0, this.columns.settings, this.options.type, this.options.format));
                        ...
                        setMessage(t) {
                            ...
                            if (s.attributes.class = s.attributes.class ? `${s.attributes.class} ${this.options.classes.table}` : this.options.classes.table,
                            this.options.tableRender) {
                        ...
                        i.selection)
                            if (Array.isArray(i.selection))
                                for (let t = 0; t < i.selection.length; t++)
                                    a = a.concat(e.pages[i.selection[t] - 1].map((t=>t.row.filter(((t,e)=>n(e))).map((t=>t.text ?? t.data)))));
                            else
                                a = a.concat(e.pages[i.selection - 1].map((t=>t.row.filter(((t,e)=>n(e))).map((t=>t.text ?? t.data)))));
                        else
                            a = a.concat(e.data.data.map((t=>t.filter(((t,e)=>n(e))).map((t=>t.text ?? t.data)))));
                        if (a.length) {
                            let t = "";
                            if (a.forEach((e=>{
                                e.forEach((e=>{
                    ...
                    exports.exportJSON = function(e, s={}) {
                        ...
                        if (i.selection)
                            if (Array.isArray(i.selection))
                                for (let t = 0; t < i.selection.length; t++)
                                    a = a.concat(e.pages[i.selection[t] - 1].map((t=>t.row.filter(((t,e)=>n(e))).map((t=>t.data)))));
                            else
                                a = a.concat(e.pages[i.selection - 1].map((t=>t.row.filter(((t,e)=>n(e))).map((t=>t.data)))));
                        else
                            a = a.concat(e.data.data.map((t=>t.filter(((t,e)=>n(e))).map((t=>t.data)))));
